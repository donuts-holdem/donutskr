  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-bg font-editorial text-ink">
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 lg:gap-6">
        {/* Logo */}
        <Link href={homeHref} aria-label="DO:NUTS 메인" className="flex min-h-11 shrink-0 items-center rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold">
          <Image
            src="/logo-v3.png"
            alt="DO:NUTS"
            width={497}
